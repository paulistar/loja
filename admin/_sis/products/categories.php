    ...
    function loopCat() {
        ...
        if ($Read->getResult()):
            foreach ($Read->getResult() as $CAT):
                ...
                echo "<li class='single_category_item' id={$CAT['cat_id']}>";
                ...
                echo "<div>{$CAT['cat_title']}</div>";
                echo "<div>";
                echo "<a title='Editar Categoria!' href='dashboard.php?wc=products/category&id={$CAT['cat_id']}' class='btn btn_blue icon-pencil icon-notext'></a> ";
                echo "<span rel='single_category_item' class='j_delete_action btn btn_red icon-cancel-circle icon-notext' id='{$CAT['cat_id']}'></span>";
                echo "<span rel='single_category_item' callback='Products' callback_action='cat_delete' class='j_delete_action_confirm btn btn_yellow icon-warning icon-notext' style='display: none;' id='{$CAT['cat_id']}'></span>";
                echo "</div>";
                echo "</div>";
