...
if (APP_POSTS_AMP && (!empty($URL[0]) && $URL[0] == 'artigo') && file_exists(REQUIRE_PATH . '/amp.php') && (!empty($URL[2]) && $URL[2] == 'amp') && (!empty($PostAmp) && $PostAmp == true)):
    ...
    <html lang="pt-br" itemscope itemtype="https://schema.org/<?= $SEO->getSchema(); ?>">
        <head>
            ...
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/bootcss/font-awesome.css"/>
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/bootcss/font-awesome-animation.css"/>
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/owl.carousel.css"/>
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/owl.theme.default.css"/>
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/jquery-ui.css"/>
            <link rel="stylesheet" href="<?= BASE; ?>/_cdn/widgets/filter/filter.css"/>
            ...
            <script src="<?= BASE; ?>/_cdn/owl.carousel.js"></script>
            <script src="<?= BASE; ?>/_cdn/jquery-ui.js"></script>
            <script src="<?= BASE; ?>/_cdn/jquery.zoom.min.js"></script>
            <script src="<?= BASE; ?>/_cdn/widgets/filter/filter.js"></script>
