        ...
        <div class="dashboard_fix">
            ...
            <nav class="dashboard_nav">
                ...
                <ul class="dashboard_nav_menu">
                    ...
                    if (APP_PRODUCTS && $_SESSION['userLogin']['user_level'] >= LEVEL_WC_PRODUCTS):
                        ...
                        <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'products/') ? 'dashboard_nav_menu_active' : ''; ?>"><a class="icon-bullhorn" title="Produtos" href="dashboard.php?wc=products/home">Produtos <?= $wc_pdt_alerts; ?></a>
                            <ul class="dashboard_nav_menu_sub">
                                ...
                                <li class="dashboard_nav_menu_sub_li <?= strstr($getViewInput, 'products/attributes') ? 'dashboard_nav_menu_active' : ''; ?>"><a title="Atributos" href="dashboard.php?wc=products/attributes">&raquo; Atributos</a></li>
                    ...
                    if (APP_FREIGHTS && $_SESSION['userLogin']['user_level'] >= LEVEL_WC_PRODUCTS_FREIGHTS):
                        ?>
                        <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'freights/') ? 'dashboard_nav_menu_active' : ''; ?>">
                            <a class="icon-cart" title="Fretes" href="dashboard.php?wc=freights/home">Fretes</a>
                        </li>
                        <?php
                    endif;
                    ...
                    if (APP_BANNERS && $_SESSION['userLogin']['user_level'] >= LEVEL_WC_BANNERS):
                        $wc_banner_alerts = null;
                        $Read->FullRead("SELECT count(banner_id) as total FROM " . DB_BANNERS . " WHERE banner_status = :status", "status=0");
                        if ($Read->getResult() && $Read->getResult()[0]['total'] >= 1):
                            $wc_banner_alerts .= "<span class='wc_alert bar_yellow'>{$Read->getResult()[0]['total']}</span>";
                        endif;
                        ?>
                        <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'banners/') ? 'dashboard_nav_menu_active' : ''; ?>"><a class="icon-camera" title="Banners" href="dashboard.php?wc=banners/home">Banners</a>
                            <ul class="dashboard_nav_menu_sub">
                                <li class="dashboard_nav_menu_sub_li <?= $getViewInput == 'banners/home' ? 'dashboard_nav_menu_active' : ''; ?>"><a title="Ver Banners" href="dashboard.php?wc=banners/home">&raquo; Ver Banners</a></li>
                                <li class="dashboard_nav_menu_sub_li <?= $getViewInput == 'banners/end' ? 'dashboard_nav_menu_active' : ''; ?>"><a title="Banners Inativos" href="dashboard.php?wc=banners/end">&raquo; Banners Inativos<?= $wc_banner_alerts; ?></a></li>
                            </ul>
                        </li>
                        <?php
                    endif;

                    if ($_SESSION['userLogin']['user_level'] >= LEVEL_WC_TEMPLATE):
                        ?>
                        <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'template') ? 'dashboard_nav_menu_active' : ''; ?>"><a class="icon-hammer2" title="Template" href="dashboard.php?wc=template/home">Template</a></li>
                        <?php
                    endif;
